...
export const trackCourseCreated = ({ courseName, grade, sections_count, duration_minutes }) =>
  logEvent(analytics, 'course_created', { courseName, grade, sections_count, duration_minutes });

export const trackCourseUpdated = ({ course_id, sections_count }) =>
  logEvent(analytics, 'course_updated', { course_id, sections_count });

export const trackAiOutlineGenerated = ({ courseName, grade, sections_count }) =>
  logEvent(analytics, 'ai_outline_generated', { courseName, grade, sections_count });
